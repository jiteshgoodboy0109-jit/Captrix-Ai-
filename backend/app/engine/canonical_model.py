...
def build_canonical_dataset(normalized_items: List[Dict[str, Any]], filename: str) -> Dict[str, Any]:
    ...
    for item in normalized_items:
        ...
        layer_a_record = {
            ...
            "raw_value": str(item.get("source_value")) if item.get("source_value") is not None else "NOT_REPORTED",
            "numeric_value": val_numeric if val is not None else None,
            "canonical_value": val_numeric if val is not None else None,
            "net_amount": val_numeric if val is not None else None,
            "unit": unit,
            "currency": currency,
            "period": year,
